...
## source : /home/duccio/lab/p224r63_2011_masked.grd
## names : B1_sre, B2_sre, B3_sre, B4_sre, B5_sre, B6_bt, B7_sre
## min values : 0.000000e+00, 0.000000e+00, 0.000000e+00, 1.196277e-02, 4.116526e-03, 2.951000e+02, 0.000000e+00
## max values : 0.1249041, 0.2563655, 0.2591587, 0.5592193, 0.4894984, 305.2000000, 0
...
use par function with the mfrowoption to  to create a matrix of nrows x ncols plots that are filled in by row. mfcol=c(nrows, ncols) fills in the matrix by columns.
